...
| Scenario | Use This Skill | Use paper-writing Instead |
|----------|---------------|------------------------------|
...
**Boundary**: paper-writing provides general ML/AI writing philosophy, multi-venue templates, and citation verification. This skill focuses exclusively on **paragraph-level structural blueprints** for systems conferences.
...
### Citation Discipline
- **Never generate citations from memory.** Use paper-writing's citation verification workflow (Semantic Scholar / DBLP / CrossRef APIs).
...
Step 6: Use paper-writing for citation verification and LaTeX formatting
```
